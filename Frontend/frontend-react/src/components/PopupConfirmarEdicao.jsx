export const PopupConfirmarEdicao = ({ isOpen, onClose, onConfirm }) => {
    ...
    <div className="fixed inset-0 bg-black/40 bg-opacity-10 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-xl max-w-sm w-full">
        <div className="text-center">
          <div className="mx-auto bg-yellow-100 p-3 rounded-full w-16 h-16 flex items-center justify-center">
            <svg
